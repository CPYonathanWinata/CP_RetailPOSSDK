...
namespace Microsoft.Dynamics.Retail.FiscalPrinter
{
    ...
    ///     - Daruma Driver  (General Messages)         = 85000 to 85049
    ///     - Fiscal Printer (General Messages)         = 85050 to 85099
    ///     - Daruma Driver  (Printer Messages)         = 85100 to 85549
    ///     - NFC-e          (All Messages)             = 85550 to 85599
    ///     - Daruma Driver  (Printer Messages)         = 85600 to 85899
    ...
    public static class Resources
    {
        ...
        public const int MessageConfirmZReportNotPending = 86178;
        public const int MessageDiscountIsNotSupportedInGiftCard = 86179; //Discount is not supported for gift card operations
        ...
        public const int FiscalDocumentModel2NoTaxesSet = 86270;
        ...
        /// <summary>
        /// The layoutid parameter cannot be specified for the layout type: {0}.
        /// </summary>
        public const int LayoutIdParameterCannotBeSpecifiedForLayoutType = 86472;
        /// <summary>
        /// The layoutid parameter must be specified for the layout type: {0}.
        /// </summary>
        public const int LayoutIdParameterShouldBeSpecifiedForLayoutType = 86473;
        /// Specified configuration file does not exist in the database.
        /// </summary>
        public const int ConfigFileDoesNotExistInDB = 86474;
        /// <summary>
        /// You can specify only one {0} line for each section.
        /// </summary>
        public const int OnlyOneLineOfThisTypeAllowedPerSection = 86502;
        /// <summary>
        /// Printing fiscal receipts for customer orders is not supported.
        /// </summary>
        public const int CustomerOrderReceiptsNotSupported = 86503;
