...
using Microsoft.Dynamics.Retail.Pos.Contracts.BusinessLogic.Systems;
...
namespace EFT
{
    ...
    public class EFT : IEFT
    {
        ...
        /// <summary>
        /// Gets or sets the asynchronous processor.
        /// </summary>
        public IEftAsynchronousProcessor EftAsynchronousProcessor { get; set; }
