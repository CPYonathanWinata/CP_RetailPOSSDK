...
namespace Microsoft.Dynamics.Retail.Pos.SalesOrder.WinFormsTouch
{
	sealed partial class formShippingInformation : frmTouchBase
	{
		...
		protected override void OnLoad(System.EventArgs e)
		{
            ...
            disableElement();
			base.OnLoad(e);
            OnSearch_Click(null, e);//custom by Yonathan 5/Jan/2023 
		}

        public void disableElement() //custom by Yonathan 3/Jan/2023
        {
            this.labelCharge.Visible = false;
            this.btnChargeChange.Visible = false;

            dateTimePicker.Value = DateTime.Now;
            dateTimePicker.Checked = true;

            //this.labelShipMethodValue.Text  = ViewModel.ShippingMethods.First(s => s.Code == "Cust");
        }
		...
		private void OnSearch_Click(object sender, EventArgs e)
		{
            ...
            OnBtnShippingMethod_Click(sender, e);
		}
