...
namespace Microsoft.Dynamics.Retail.Pos.Item.WinFormsTouch
{
    ...
    public class frmSerialIdSearch : LSRetailPosis.POSProcesses.frmTouchBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnPgDown.Location = new System.Drawing.Point(894, 11);
            ...
            this.btnDown.Location = new System.Drawing.Point(829, 11);
        ...
        private void frmSerialIdSearch_Load(object sender, EventArgs e)
        {
            ...
            // Pre-select current serial number of the item.
            if (!String.IsNullOrEmpty(this.selectedSerialId))
            {
                txtKeyboardInput.Text = this.selectedSerialId;
                int rowHandle = grdView.LocateByValue("INVENTSERIALID", this.selectedSerialId);
                
                if (rowHandle != DevExpress.XtraGrid.GridControl.InvalidRowHandle)
                {
                    grdView.MakeRowVisible(rowHandle,false);
                    grdView.SelectRow(rowHandle);
                }
            }
