...
namespace Microsoft.Dynamics.Retail.Pos.Loyalty
{
    ...
    internal class LoyaltyHelper
    {
        ...
        public LoyaltyCard GetLoyaltyCard(ICardInfo cardInfo)
        {
         ...
         //   MessageBox.Show(cardNumber + " success"); dapet no kartu nya
        ...
        public Contracts.DataEntity.ICustomer GetCustomer(string partyNumber)
        {
          ...
          //      MessageBox.Show(partyNumber + "partyNumber");
        ...
        public static void CPupdateUplineProgram(string _cardNumber)
        {
            SqlConnection connection = LSRetailPosis.Settings.ApplicationSettings.Database.LocalConnection;
            try
            {

                string queryString = @"exec CP_UpdateLoyaltyCard @CARDNUMBER  ";

                using (SqlCommand command = new SqlCommand(queryString, connection))
                {
                    command.Parameters.AddWithValue("@CARDNUMBER", _cardNumber);
            ...
            {
                LSRetailPosis.ApplicationExceptionHandler.HandleException("Error", ex);
                throw;
            }
            finally
            {
