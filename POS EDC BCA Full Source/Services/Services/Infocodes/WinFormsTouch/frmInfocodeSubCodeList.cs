...
namespace Microsoft.Dynamics.Retail.Pos.Services.InfoCodes
{
    ...
    internal class FormInfoCodeSubCodeList : FormInfoCodeSubCodeBase
    {
        ...
        /// <summary>
        /// Set visibillity to price column
        /// </summary>
        public bool ShowPriceColumn
        {
            set
            {
                colDescription.Width = value ? 350 : 715;
                colPrice.Visible = value;
                colPrice.VisibleIndex = value ? 1 : -1;
                showPriceColumn = value;
            }
            get { return showPriceColumn; }
        }
        ...
        public FormInfoCodeSubCodeList(bool showPriceColumn)
        {
            //
        ...
        public FormInfoCodeSubCodeList() : this(false)
        {
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            if (!this.DesignMode)
            {
                ...
                grdView.FocusedColumn = grdView.Columns["DESCRIPTIONINWORKERLANGUAGE"];
                ...
                if (inputRequired && ((itemTable != null) && (itemTable.Rows.Count > 0)) )
                {   // Hide the Canel button when input is required (and available)
        ...
        private void TranslateLabels()
        {
            ...
            grdView.Columns["DESCRIPTIONINWORKERLANGUAGE"].Caption = LSRetailPosis.ApplicationLocalizer.Language.Translate(60007); //Description
        ...
        private void InitializeComponent()
        {
            ...
            this.grItems.Location = new System.Drawing.Point(29, 225);
            this.grItems.MainView = this.grdView;
            this.grItems.Name = "grItems";
            this.grItems.Size = new System.Drawing.Size(962, 449);
            ...
            this.colDescription.FieldName = "DESCRIPTIONINWORKERLANGUAGE";
            ...
            this.tableLayoutPanel1.Controls.Add(this.grItems, 0, 3);
            ...
            this.tableLayoutPanel2.Location = new System.Drawing.Point(26, 185);
            ...
            this.textBox.Properties.Appearance.Font = new System.Drawing.Font("Segoe UI", 14F);
            ...
            this.textBox.Size = new System.Drawing.Size(836, 32);
            ...
            this.tableLayoutPanel1.SetColumnSpan(this.labelItemDescription, 8);
        ...
        private void SelectItem()
        {
            if (grdView.RowCount > 0)
            {
                ...
                selectedDescriptionInWorkerLanguage = (string)Row["DESCRIPTIONINWORKERLANGUAGE"];
        ...
        private DataTable GetInfoCodeList(string fromName, string searchString, int numberOfItems)
        {
            ...
            using (SqlCommand command = new SqlCommand())
            {
                ...
                queryString.AppendLine(" ISNULL(SCT.SUBCODEID, '') AS SUBCODEID, ISNULL(SCT.PRICETYPE, 0) AS PRICETYPE, ISNULL(SCT.TRIGGERFUNCTION, 0) AS TRIGGERFUNCTION, ");
                queryString.AppendLine(" ISNULL(SCT.TRIGGERCODE, '') AS TRIGGERCODE, ISNULL(SCT.AMOUNTPERCENT, 0) AS AMOUNTPERCENT, ");
                queryString.AppendLine(" ISNULL(ISNULL(SCTRANSONWORKER.DESCRIPTION, SCT.SUBCODEID), '') AS DESCRIPTIONINWORKERLANGUAGE, ");
                queryString.AppendLine(" ISNULL(ISNULL(SCTRANSONTERMINAL.DESCRIPTION, SCT.SUBCODEID), '') AS DESCRIPTION ");
                queryString.AppendLine(" FROM RETAILINFORMATIONSUBCODETABLE SCT");
                queryString.AppendLine(" LEFT OUTER JOIN RETAILINFORMATIONSUBCODETRANSLATION SCTRANSONWORKER ON SCTRANSONWORKER.INFOSUBCODE = SCT.RECID AND SCT.DATAAREAID = SCTRANSONWORKER.DATAAREAID AND SCTRANSONWORKER.LANGUAGEID = @CULTURE ");
                queryString.AppendLine(" LEFT OUTER JOIN RETAILINFORMATIONSUBCODETRANSLATION SCTRANSONTERMINAL ON SCTRANSONTERMINAL.INFOSUBCODE = SCT.RECID AND SCT.DATAAREAID = SCTRANSONTERMINAL.DATAAREAID AND SCTRANSONTERMINAL.LANGUAGEID = @TERMINALCULTURE ");
                queryString.AppendLine(" WHERE SCT.DATAAREAID=@DATAAREAID ");
                queryString.AppendLine(" AND SCT.INFOCODEID=@INFOCODEID ");
                ...
                SqlParameter workerCultureParam = command.Parameters.AddWithValue("@CULTURE ", Thread.CurrentThread.CurrentUICulture.Name);
                SqlParameter terminalCultureParam = command.Parameters.AddWithValue("@TERMINALCULTURE ", ApplicationSettings.Terminal.CultureName);

                if (searchString.Length > 0)
                {
                    queryString.AppendLine("AND (SCTRANSONWORKER.DESCRIPTION LIKE @SearchString) "); // OR PRICE LIKE @SearchString) ";
                    command.Parameters.AddWithValue("@SEARCHSTRING", '%' + searchString + '%');
                }

                if (fromName.Length > 0)
                {
                    queryString.AppendLine("AND SCT.SUBCODEID > @FROMDESCRIPTION ");
                    command.Parameters.AddWithValue("@FROMDESCRIPTION", fromName);
                }

                queryString.AppendLine("ORDER BY SCT.SUBCODEID");
            ...
            foreach (DataRow row in subcodeTable.Rows)
            {
                ...
                switch ((LSRetailPosis.POSProcesses.PriceTypeEnum)row["PRICETYPE"])
                {
                    ...
                    case LSRetailPosis.POSProcesses.PriceTypeEnum.Price:
                        displayPrice = rounding.RoundForDisplay(amount, ApplicationSettings.Terminal.StoreCurrency, true, false);
                        break;
