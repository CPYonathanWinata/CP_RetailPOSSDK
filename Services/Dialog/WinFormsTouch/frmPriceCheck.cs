...
namespace Microsoft.Dynamics.Retail.Pos.Dialog.WinFormsTouch
{
	...
	public class frmPriceCheck : frmTouchBase
    {
        ...
        /// <summary>
        /// Get/set saleItem proeprty.
        /// </summary>
        public SaleLineItem SaleItem
        {
            get { return saleItem; }
            set { saleItem = value; }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!this.DesignMode)
            {
                ...
                //
                this.labelHeading.Text = ApplicationLocalizer.Language.Translate(1403); // "Price check"
                this.Text = ApplicationLocalizer.Language.Translate(1403); // "Price check"    
        ...
        private void InitializeComponent()
        {
            ...
            // layPriceInfo
            // 
            this.layPriceInfo.AllowCustomization = false;
        ...
        private void checkItemPrice(string barcode)
        {
            ...
            else
            {
                ...
                // Concatenate dimensions with item description if it is a variant item {Color - Size - Style - Config}
                if (!string.IsNullOrEmpty(saleLineItem.Dimension.VariantId))
                {
                    ...
                    saleLineItem.Description += dimensionSeparator + dimensions.ToString();
                }
