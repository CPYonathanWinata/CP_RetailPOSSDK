...
namespace Microsoft.Dynamics.Retail.FiscalPrinter
{
    public static class FiscalPrinterUtility
    {
        ...
        /// <summary>
        /// Creates text style based on fontStyleType and partner data.
        /// </summary>
        ...
        public static IFiscalPrinterFontStyle CreateFiscalPrinterFontStyle(FontStyleType fontStyleType, dynamic partnerData)
        {
            var fontStyle = new FiscalPrinterFontStyle();
            fontStyle.FontStyleType = fontStyleType;
            fontStyle.PartnerData = partnerData;
            return fontStyle;

        }

        /// <summary>
        /// Creates text style with text based on text, fontStyleType and partner data.
        /// </summary>
        /// <param name="text">Text to print.</param>
        /// <param name="fontStyleType">Style of the text.</param>
        /// <param name="partnerData">Dynamic object that hold partner's data.</param>
        /// <returns>return the object created.</returns>
        public static IFiscalPrinterTextData CreateFiscalPrinterTextData(string text, FontStyleType fontStyleType, dynamic partnerData)
        {
            var textWithFormatting = new FiscalPrinterTextData();
            textWithFormatting.Text = text;
            textWithFormatting.FontStyle = new FiscalPrinterFontStyle();
            textWithFormatting.FontStyle.FontStyleType = fontStyleType;
            textWithFormatting.FontStyle.PartnerData = partnerData;
        ...
        public static IFiscalPrinterTextData CreateFiscalPrinterTextData(string text, IFiscalPrinterFontStyle fontStyle)
        {
            var textWithFormatting = new FiscalPrinterTextData();
            textWithFormatting.Text = text;
            textWithFormatting.FontStyle = fontStyle;
            return textWithFormatting;
        }

        /// <summary>
        /// Creates default fiscal printer font style
        /// </summary>
        /// <returns>Returns the fiscal printer font style.</returns>
        public static IFiscalPrinterFontStyle CreateDefaultFiscalPrinterFontStyle()
        {
            return new FiscalPrinterFontStyle { FontStyleType = FontStyleType.Normal };
        }
    }
}
