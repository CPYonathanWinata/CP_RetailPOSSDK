            ...
            if (_itemIdMulti != "")
            {
                try
                {
                    ...
                    if (statusTrans == true)
                    {
                        ...
                        //var result = apiFunction.checkStockOnHandMulti(application, urlRTS, application.Settings.Database.DataAreaID, _siteId, ApplicationSettings.Terminal.InventLocationId, _itemIdMulti, "", "", "");//, _qtyMulti, posTransaction.StoreId + "-FORMCHECKSTOCK"); 
                        //end
