...
namespace Microsoft.Dynamics.Retail.FiscalPrinter
{
    ...
    public static class UserMessages
    {
        ...
        /// <summary>
        /// Request general data using the numeric pad
        /// </summary>
        /// <param name="text">The message</param>
        /// <returns>The string representation of the data, or "-1" if the cancel button is pressed</returns>
        public static string RequestData(string text)
        {
            using (var form = new frmInputNumpad())
            {
                form.EntryTypes = NumpadEntryTypes.IntegerPositive;
                form.PromptText = text;

                return form.ShowDialog() == DialogResult.OK ? form.InputText : "-1";
            }
        }
