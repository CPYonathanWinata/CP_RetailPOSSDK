...
namespace Microsoft.Dynamics.Retail.Pos.Dialog
{
    ...
    public class Dialog : IDialog
    {
        ...
        public void ShowJournalDialog(ref JournalDialogResults journalDialogResults, ref object dialogResultObject, IPosTransaction posTransaction)
        {
            ...
            var useCancelTransactionButton = ApplicationSettings.Terminal.OperationMode == Terminal.RetailTerminalOperationMode.EFDocConsumer 
                                            && Functions.CountryRegion == SupportedCountryRegion.BR;

            using (frmJournal journalDialog = new frmJournal(posTransaction, Application, useCancelTransactionButton))
            {
