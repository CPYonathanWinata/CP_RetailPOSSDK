    ...
    public partial class ProductDetailsForm : frmTouchBase, IInteractionView
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            if (!this.DesignMode)
            {
                ...
                this.toolTip1.SetToolTip(this.lblCategoryValue, this.lblCategoryValue.Text);
                this.toolTip1.SetToolTip(this.lblDescriptionValue, this.lblDescriptionValue.Text);
            }
            base.OnLoad(e);
        }
