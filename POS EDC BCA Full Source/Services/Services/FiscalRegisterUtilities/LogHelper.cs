...
namespace Microsoft.Dynamics.Retail.FiscalRegistrationServices
{
    ...
    {
        private const string LogPrefix = "FiscalRegister.";
        ...
        /// <summary>
        /// Log an exception in the POS logging destination.
        /// </summary>
        /// <param name="source"></param>
        /// <param name="errorMessage"></param>
        /// <param name="args"></param>
        public static void LogException(Exception ex, string source, string errorMessage, params object[] args)
        {
            NetTracer.Error(ex, string.Format("{0}{1} {2}", LogPrefix, source, string.Format(errorMessage, args)));
        }
    }
}
