...
namespace Microsoft.Dynamics.Retail.Pos.Tax
{
    ...
    {
        /// <summary>
        /// Create an instance ot TaxDataBrazil
        /// </summary>
        public TaxDataBrazil TaxData { get; set; }
            ...
            : base(application)
        {
            ...
            TaxData = new TaxDataBrazil(connection, dataAreaId);
        }
        ...
        protected override string TaxSelectSqlText
        {
            get
            {
                ...
                sb.AppendLine("TAXTABLE.TAXTYPE_BR, ");
