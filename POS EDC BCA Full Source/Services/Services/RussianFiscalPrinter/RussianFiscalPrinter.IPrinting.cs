...
namespace Microsoft.Dynamics.Retail.FiscalPrinter.RussianFiscalPrinter
{
    public sealed partial class RussianFiscalPrinter
    {
        ...
        public void PrintGiftCardsBalance(IList<IGiftCardLineItem> giftCardsList, IRetailTransaction transaction)
        {
            ...
            {
                LogHelper.LogTrace("FiscalPrinter.IPrinting.PrintGiftCardsBalance", "giftCardsData is empty"); 
            }
            LogHelper.LogTrace("FiscalPrinter.IPrinting.PrintGiftCardsBalance", "giftCardsData = {0}", giftCardsList == null || giftCardsList.Count == 0 ? giftCardsList : giftCardsList.ToArray());

            RussianFiscalPrinterDriver.FiscalPrinterDriver.PrintGiftCardsBalance(giftCardsList, transaction);
        }        
    }
}
