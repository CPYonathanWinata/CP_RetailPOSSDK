...
namespace Microsoft.Dynamics.Retail.FiscalPrinter.RussianFiscalPrinter
{
    ...
    public abstract partial class RussianFiscalPrinterDriver : IFiscalPrinterDriver
    {
        ...
        public abstract void PrintGiftCardsBalance(IList<IGiftCardLineItem> giftCardsList, IRetailTransaction transaction);
        ...
        public abstract int GetLineLength(IFiscalPrinterFontStyle fontStyle);
        ...
        public abstract void PrintCustomDocument(string layoutId, IList<IFiscalPrinterTextData> textToPrint, IPosTransaction posTransaction);
