...
namespace Microsoft.Dynamics.Retail.Pos.Services.InfoCodes
{
    ...
    internal class FormInfoSubCode : FormInfoCodeSubCodeBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tableLayoutPanel2.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
            this.tableLayoutPanel2.Location = new System.Drawing.Point(356, 278);
        ...
        protected override void OnLoad(EventArgs e)
        {
            if (!this.DesignMode)
            {
                ...
                // Get subcodes translated to operator language 
                DataTable infoSubCodes = infoCodeData.GetSubInfoCode(infoCodeId, System.Threading.Thread.CurrentThread.CurrentUICulture.Name);
        ...
        private void ClickHandler(object sender, EventArgs e)
        {
            ...
            selectedDescriptionInWorkerLanguage = tmpButton.Text;
