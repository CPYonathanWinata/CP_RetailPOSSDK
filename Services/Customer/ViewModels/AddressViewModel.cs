...
namespace Microsoft.Dynamics.Retail.Pos.Customer.ViewModels
{
    public class AddressViewModel : INotifyPropertyChanged
    {
        ...
        public AddressType AddressType
        {
            ...
            set
            {
                if (this.Address.AddressType != value)
                {
                    ...
                    OnPropertyChanged("FormattedAddressType");
                }
            }
        }

        /// <summary>
        /// Localized AddressType description
        /// </summary>
        public string FormattedAddressType
        {
            get 
            {
                return this.AddressType.ToLocalizedString();
            }
        }
        ...
        internal void ExecuteSelectAddressType()
        {
            ...
            using (DataTable table = new DataTable("ADDRESSTYPES"))
            {
                ...
                DataRow[] rows = table.Select(string.Format("TYPE = {0}", this.AddressType.ToString("D")));
                DataRow row = rows.Length > 0 ? rows[0] : null;
                DialogResult result = Customer.InternalApplication.Services.Dialog.GenericLookup(
    ...
    static class AddressViewModelExtensions
    {
        public static string ToLocalizedString(this AddressType arg)
        {
            ...
            switch (arg)
            {
                case AddressType.None:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51170); // "None"
                    break;
                case AddressType.Invoice:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51171); // "Invoice"
                    break;
                case AddressType.Delivery:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51172); // "Delievry"
                    break;
                case AddressType.SWIFT:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51174); // "SWIFT"
                    break;
                case AddressType.Payment:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51175); // "Payment"
                    break;
                case AddressType.Service:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51176); // "Service"
                    break;
                case AddressType.Home:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51177); // "Home"
                    break;
                case AddressType.Other:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51178); // "Other"
                    break;
                case AddressType.Business:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51179); // "Business"
                    break;
                case AddressType.RemitTo:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51180); // "RemitTo"
                    break;
                case AddressType.ShipCarrierThirdPartyShipping:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51181); // "3rd Party Shipping"
                    break;
                case AddressType.Statement:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51195); // "Statement"
                    break;
                case AddressType.FixedAsset:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51196); // "Fixed Asset"
                    break;
                case AddressType.Onetime:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51197); // "One Time"
                    break;
                case AddressType.Recruit:
                    translated = LSRetailPosis.ApplicationLocalizer.Language.Translate(51198); // "Recruit"
                    break;
                default:
                    translated = arg.ToString("G");
                    break;
            }
