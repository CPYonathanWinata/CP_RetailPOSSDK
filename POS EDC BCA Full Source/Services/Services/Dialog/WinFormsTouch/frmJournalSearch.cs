...
namespace Microsoft.Dynamics.Retail.Pos.Dialog.WinFormsTouch
{
    ...
    public partial class frmJournalSearch : frmTouchBase
    {
        ...
        public frmJournalSearch()
        {
            ...
            List<TypeOfTransaction> list = new List<TypeOfTransaction>();
            list.Add(TypeOfTransaction.Sales);
            this.SearchCriteria = new SalesOrderSearchCriteria { SalesTransactionTypes = list, IncludeDetails = true };
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            List<TypeOfTransaction> list = new List<TypeOfTransaction>();
            list.Add(TypeOfTransaction.Sales);
            this.SearchCriteria = new SalesOrderSearchCriteria {
                 SalesTransactionTypes = list,
                IncludeDetails = true };
            SetFormFocus();
        }
